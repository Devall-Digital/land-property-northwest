...
<div class="lpnw-off-market-submit">
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="lpnw-off-market-submit__form">
		...
		<div class="lpnw-off-market-submit__field lpnw-off-market-submit__field--honeypot" aria-hidden="true">
		...
		<div class="lpnw-off-market-submit__field">
			<label for="lpnw_om_address"><?php esc_html_e( 'Address or location', 'lpnw-alerts' ); ?> <span class="required">*</span></label>
			<input type="text" name="lpnw_om_address" id="lpnw_om_address" required maxlength="500" class="lpnw-off-market-submit__control" />
		</div>

		<div class="lpnw-off-market-submit__grid">
			<div class="lpnw-off-market-submit__field">
				<label for="lpnw_om_postcode"><?php esc_html_e( 'Postcode', 'lpnw-alerts' ); ?> <span class="required">*</span></label>
				<input type="text" name="lpnw_om_postcode" id="lpnw_om_postcode" required maxlength="12" class="lpnw-off-market-submit__control" autocomplete="postal-code" />
			</div>
			<div class="lpnw-off-market-submit__field">
				<label for="lpnw_om_property_type"><?php esc_html_e( 'Property type', 'lpnw-alerts' ); ?> <span class="required">*</span></label>
				<select name="lpnw_om_property_type" id="lpnw_om_property_type" required class="lpnw-off-market-submit__control">
		...
		<div class="lpnw-off-market-submit__grid">
			<div class="lpnw-off-market-submit__field">
				...
				<select name="lpnw_om_application_type" id="lpnw_om_application_type" class="lpnw-off-market-submit__control">
			...
			<div class="lpnw-off-market-submit__field">
				...
				<input type="number" name="lpnw_om_price" id="lpnw_om_price" min="0" step="1000" class="lpnw-off-market-submit__control" />
			</div>
		</div>

		<div class="lpnw-off-market-submit__field">
			<label for="lpnw_om_bedrooms"><?php esc_html_e( 'Bedrooms (optional)', 'lpnw-alerts' ); ?></label>
			<input type="number" name="lpnw_om_bedrooms" id="lpnw_om_bedrooms" min="0" max="50" step="1" class="lpnw-off-market-submit__control" />
		</div>

		<div class="lpnw-off-market-submit__field">
			<label for="lpnw_om_description"><?php esc_html_e( 'Brief description', 'lpnw-alerts' ); ?></label>
			<textarea name="lpnw_om_description" id="lpnw_om_description" rows="5" class="lpnw-off-market-submit__control" maxlength="8000"></textarea>
		</div>

		<div class="lpnw-off-market-submit__field">
			<label for="lpnw_om_contact"><?php esc_html_e( 'How others should contact you (email or phone)', 'lpnw-alerts' ); ?></label>
			<input type="text" name="lpnw_om_contact" id="lpnw_om_contact" maxlength="255" class="lpnw-off-market-submit__control" />
		</div>

		<div class="lpnw-off-market-submit__field">
			<label for="lpnw_om_reason"><?php esc_html_e( 'Why it is off-market (optional)', 'lpnw-alerts' ); ?></label>
			<textarea name="lpnw_om_reason" id="lpnw_om_reason" rows="3" class="lpnw-off-market-submit__control" maxlength="2000"></textarea>
		</div>

		<div class="lpnw-off-market-submit__actions">
