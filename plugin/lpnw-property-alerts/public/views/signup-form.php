...
<?php else : ?>
	<div class="lpnw-login-prompt lpnw-signup-form lpnw-signup-form--guest">
		...
		<p class="lpnw-signup-form__intro"><?php esc_html_e( 'Create a free account in a minute. We start you on Northwest listing alerts right away, then send you to preferences to narrow areas and filters. Free accounts get a weekly digest; upgrade when you want instant alerts.', 'lpnw-alerts' ); ?></p>
