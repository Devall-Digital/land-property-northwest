...
<?php else : ?>
	<div class="lpnw-login-prompt lpnw-signup-form lpnw-signup-form--guest">
		...
		<p class="lpnw-signup-form__intro"><?php esc_html_e( 'Create a free account to start receiving weekly property alerts for the Northwest. Upgrade anytime for instant alerts.', 'lpnw-alerts' ); ?></p>
