				...
				<article class="lpnw-property-card<?php echo $is_off_market ? ' lpnw-property-card--off-market' : ''; ?>" aria-labelledby="<?php echo esc_attr( $title_id ); ?>">
					...
					<header class="lpnw-property-card__header">
						...
						<?php if ( ! empty( $prop->postcode ) ) : ?>
							<?php $lpnw_pc_cap = class_exists( 'LPNW_Property' ) ? LPNW_Property::format_postcode_caption( $prop ) : ''; ?>
							<p class="lpnw-property-card__postcode"><?php echo esc_html( $prop->postcode ); ?><?php echo '' !== $lpnw_pc_cap ? ' — ' . esc_html( $lpnw_pc_cap ) : ''; ?></p>
						<?php endif; ?>
					</header>
					...
					<footer class="lpnw-property-card__actions">
						<?php if ( $is_off_market ) : ?>
							...
							<?php endif; ?>
						<?php elseif ( ! empty( $prop->source_url ) ) : ?>
